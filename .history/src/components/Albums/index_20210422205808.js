...
class Albums extends React.Component {
  render() {
    ...
    let album3 = {
      vinyl: require("../../assets/images/orangeVinyl.png"),
      cover: require("../../assets/images/soundcloudCover.png"),
      link:
        "https://soundcloud.com/joshuaachorn/sets/live-at-the-laughing-goat",
    };
    ...
    return (
      <div className={classes.Albums}>
        ...
        <Album cover={album3.cover} vinyl={album3.vinyl} link={album3.link} />
      </div>
    );
  }
}
